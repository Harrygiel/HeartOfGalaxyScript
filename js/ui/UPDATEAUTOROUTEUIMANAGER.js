...
UpdateAutoRouteUIManager.prototype.UpdatePlanetUIAlertState = function(planetDiv, isOnAlert, storageNeeded){
	if(isOnAlert){
        ...
        (new m(250,
            20, "<span class='blue_text' style='width:100%;text-align:center'>" + Math.floor(storageNeeded/1000000) + "M more storage needed. Buy and add " + _this.core.GetZB50Needed(storageNeeded) + " more ZB50 to the road</span>", "info")).drawInfo();
